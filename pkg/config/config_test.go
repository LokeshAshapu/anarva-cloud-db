...
func TestLoadConfig_EnvOverride(t *testing.T) {
	...
	os.Setenv("STORAGE_S3_BUCKET", "prod-bucket")
	os.Setenv("STORAGE_S3_ACCESS_KEY", "prod-key")
	os.Setenv("STORAGE_S3_SECRET_KEY", "prod-secret")
	defer func() {
		...
		os.Unsetenv("STORAGE_S3_ACCESS_KEY")
		os.Unsetenv("STORAGE_S3_SECRET_KEY")
	}()
