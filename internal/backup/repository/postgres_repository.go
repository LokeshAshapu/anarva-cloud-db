...
func (r *backupRepository) Create(ctx context.Context, snapshot *domain.BackupRecord) error {
...
func (r *backupRepository) GetByID(ctx context.Context, id string) (*domain.BackupRecord, error) {
	var snapshot domain.BackupRecord
...
func (r *backupRepository) ListByDatabaseID(ctx context.Context, databaseID string) ([]*domain.BackupRecord, error) {
	var snapshots []*domain.BackupRecord
...
func (r *backupRepository) ListByProjectID(ctx context.Context, projectID string) ([]*domain.BackupRecord, error) {
	var snapshots []*domain.BackupRecord
...
func (r *backupRepository) Update(ctx context.Context, snapshot *domain.BackupRecord) error {
...
func (r *backupRepository) Delete(ctx context.Context, id string) error {
	if err := r.db.WithContext(ctx).Delete(&domain.BackupRecord{}, "id = ?", id).Error; err != nil {
