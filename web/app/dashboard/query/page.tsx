  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white tracking-tight">Interactive SQL Query Console</h1>
          <p className="text-slate-400 text-xs sm:text-sm mt-1">Execute SQL statements with safety AST validation and real-time execution telemetry.</p>
        </div>

        <button
          onClick={handleExecute}
          disabled={loading}
          className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg transition shadow-lg shadow-blue-600/25 disabled:opacity-50 text-sm"
        >
