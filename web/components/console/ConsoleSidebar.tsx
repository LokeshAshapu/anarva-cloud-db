...
export function ConsoleSidebar() {
  ...
  return (
    <aside
      className={`hidden lg:flex flex-col border-r border-slate-800/90 bg-slate-950/90 backdrop-blur-xl transition-all duration-300 ${
    ...
    >
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center justify-between px-3 py-2 rounded-xl text-xs font-semibold transition group ${
                      isActive
                        ? 'bg-blue-600/15 text-white border border-blue-500/30 shadow-sm font-bold'
                  ...
                  >
                    ...
                    {!isCollapsed && item.badge && (
                      <span className="text-[9px] font-mono font-extrabold px-1.5 py-0.2 bg-blue-500/10 text-blue-400 border border-blue-500/20 rounded">
                        {item.badge}
                      </span>
                    )}
                  </Link>
      ...
      <div className="p-3 border-t border-slate-800/90 flex justify-end">
        <button
          onClick={toggleCollapse}
          className="p-2 text-slate-400 hover:text-white bg-slate-900/80 hover:bg-slate-800 border border-slate-800 rounded-lg text-xs transition flex items-center justify-center w-full"
